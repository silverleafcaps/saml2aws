...
// AllHeaders provides a mock function with no fields
func (_m *Request) AllHeaders() (map[string]string, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for AllHeaders")
	}
...
// Frame provides a mock function with no fields
...
func (_m *Request) HeaderValue(name string) (string, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for HeaderValue")
	}
...
// HeadersArray provides a mock function with no fields
func (_m *Request) HeadersArray() ([]playwright.NameValue, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for HeadersArray")
	}
...
// IsNavigationRequest provides a mock function with no fields
func (_m *Request) IsNavigationRequest() bool {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for IsNavigationRequest")
	}
...
// PostData provides a mock function with no fields
func (_m *Request) PostData() (string, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for PostData")
	}
...
// PostDataBuffer provides a mock function with no fields
func (_m *Request) PostDataBuffer() ([]byte, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for PostDataBuffer")
	}
...
func (_m *Request) PostDataJSON(v interface{}) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for PostDataJSON")
	}
...
// RedirectedFrom provides a mock function with no fields
func (_m *Request) RedirectedFrom() playwright.Request {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for RedirectedFrom")
	}
...
// RedirectedTo provides a mock function with no fields
func (_m *Request) RedirectedTo() playwright.Request {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for RedirectedTo")
	}
...
// ResourceType provides a mock function with no fields
...
// Sizes provides a mock function with no fields
...
// Timing provides a mock function with no fields
